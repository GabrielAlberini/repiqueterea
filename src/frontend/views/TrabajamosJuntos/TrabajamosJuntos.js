...
const TrabajamosJuntos = () => {
  return (
    <>
      <Layout>
        <Title title="Trabajamos juntos" />
        <section className="section-trabajamos-juntos">
          <div>
            <p>
              En realidad, los artistas independientes trabajamos todo el
              tiempo, no tenemos un horario fijo ni tampoco un plan de acción
              riguroso. La <span className="texto-coloreado">creatividad</span> no espera y te puede encontrar en los
              momentos más insolitos del día.
            </p>
            <p>
            ...
            <p>
              ...
              en constante contacto con otres. Por eso, si tenes una <span className="texto-coloreado">idea</span>, <span className="texto-coloreado">una
              sugerencia</span>, <span className="texto-coloreado">una opinión</span>, <span className="texto-coloreado">un proyecto</span> o lo que sea, aquí estoy para
              comenzar a trabajar.
            </p>
            <p>
          ...
          <div className="cont-main-img-trabajamos-juntos">
            <div>
              <img src="https://i.ibb.co/9WBq1wf/1.jpg" alt="imagenes de cuadro" />
            </div>
            <div>
              <img src="https://i.ibb.co/J2YzRhy/2.jpg" alt="imagenes de cuadro" />
            </div>
            <div>
              <img src="https://i.ibb.co/VLCw2Hp/3.jpg" alt="imagenes de cuadro" />
            </div>
          </div>
        </section>
      </Layout>
